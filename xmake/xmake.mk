...
$(strip	\
	$(patsubst $(_XMAKE_TOPDIR)/%,$(_XMAKE_OBJS_DIR)/exe/%.o.d,$(abspath $(1)))	\
...
define build-shared-library
	...
	mkdir -p $(dir $(1))
	echo "CC -shared $(LDFLAGS) $(XMAKE_SHARED_LDFLAGS) $(PRIVATE_LDFLAGS) -DPIC -fPIC -rdynamic -Wl,-Bsymbolic -o $(1) $(2)"
	$(CC) -shared -fPIC $(LDFLAGS) $(XMAKE_SHARED_LDFLAGS) $(PRIVATE_LDFLAGS) -DPIC -fPIC -rdynamic -Wl,-Bsymbolic -o $(1) $(2)
	echo "$(1) build done."
	echo "------------------------------"
endef
...
define build-shared-library-by-dirs
	mkdir -p $(dir $(1))
	_objs=`for d in $(2); do find $$d -name *.o; done`;	\
		echo "CC -shared $(LDFLAGS) $(XMAKE_SHARED_LDFLAGS) $(PRIVATE_LDFLAGS) -DPIC -fPIC -rdynamic -Wl,-Bsymbolic -o $(1) $$_objs";	\
		$(CC) -shared -fPIC $(LDFLAGS) $(XMAKE_SHARED_LDFLAGS) $(PRIVATE_LDFLAGS) -DPIC -fPIC -rdynamic -Wl,-Bsymbolic -o $(1) $$_objs
	echo "$(1) build done."
	echo "------------------------------"
endef
...
define build-object
	...
	mkdir -p $(dir $(1));
	$(CC) $(CFLAGS) $(3) -o $(1) -c $(2) || ( echo "compile command:"; echo "$(CC) $(CFLAGS) $(3) -o $(1) -c $(2)"; false )
